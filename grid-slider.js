...
const gridSlider = (function gridSlider(el, options){
	    ...
	    //     	elements = el.find(settings.selector);
...
window.gridSlider = gridSlider;
console.log(window.gridSlider);
document.addEventListener("DOMContentLoaded", () => {
	var sliders = document.querySelectorAll('.grid-slider');
	sliders.forEach((slider) => {
		console.log(slider);
	  	slider.gridSlider = window.gridSlider;
	  	slider.gridSlider();
	});
});